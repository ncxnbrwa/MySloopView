...
/**
 * @author xiong
 * @ClassName: BezierLovingHeartView
 * @Description: todo(从圆到心形图的渐变)
 * @date 2017/1/6
 */

public class BezierLovingHeartView extends View
{
    ...
    public BezierLovingHeartView(Context context)
    {
        this(context, null);
    }

    public BezierLovingHeartView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        mPaint = new Paint();
